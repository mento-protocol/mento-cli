# Contributing to Mento CLI

The following is a set of guidelines for contributing to the Mento CLI. Reading and following the guidelines will help make the contribution process easy and allow us to maintain a consistent standard of code & quality.
